        ...
        <div className="container flex flex-col px-6 py-12 mx-auto">
          <div className="flex-1 lg:flex lg:items-center justify-center lg:-mx-6">
            <div className="mt-8 lg:w-1/2 lg:mx-6">
              <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-xl border-1 border-gray-100 rounded-xl lg:max-w-xl">
            ...
            <div className="flex flex-col items-center 2xl:py-0 py-10 2xl:items-start text-black lg:w-1/3 lg:mx-6">
              <div className=""><p className="max-w-xl mt-6">
              ...
              <div className="mt-6 space-y-8 md:mt-8">
                <p className="flex items-start -mx-2">
                  ...
                  <span className="mx-2 text-black truncate w-84">
                    Tawn School Road, Barishal-8200, Bangladesh
                  </span>
                </p>
